import {LogOut,Menu,X,LayoutDashboard,MapPin,Calendar,User,ChevronDown} from "lucide-react";
...
export default function VendorLayout({ children }: VendorLayoutProps) {
    ...
    const navItems = [
        ...
        {
        path: "/vendor/reserve-stalls",
        label: "Reserve Stalls",
        icon: MapPin
        },
        {
        path: "/vendor/my-reservations",
